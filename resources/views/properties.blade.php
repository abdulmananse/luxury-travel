            ...
            <form method="GET" action="{{ route('search') }}" class="row g-3 form-input search-form">
                <div class="property">
                    ...
                    <div class="date-input">
                        ...
                        <input id="demo" type="text" name="datefilter" value="Mar 20 Mar 23" inputmode="none" />
                    </div>
                    <div class="d-flex drop-menu guests-border">
                        <p class="select-search">GUESTS</p>
                        <div class="select-destionation">
                            <p class="value-drop">2 Guests</p>
                            <img src="{{ asset('img') }}/downninvalid-name@3x.png" />
                        </div>
                        <div class="dropdown-open guests-open">
                            <div class="d-flex guests-range">
                                <p>-</p>
                                <p>1</p>
                                <p>+</p>
                            </div>
                            <div class="d-flex guests-button">
                                <button class="guests-clear">Clear</button>
                                <button class="guests-applay">Applay</button>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex drop-menu guests-border">
                            ...
                            <div class="card-content">
                                ...
                                <div class="bedrooms">
                                    ...
                                    <div class="publisher-contact d-flex icon-i">
                                        ...
                                        <div class="cost-info">
                                            <p>$19,567</p>
                                            <img class="info-i" src="{{ asset('img') }}/infoinvalid-name@3x.png" />
                                        </div>
                                    </div>
                                    <div class="publisher-contact d-flex">
